...
async function init () {
  ...
  console.log('   Trying to spend care point with working token..'.grey)
  updatedGame = await kamerbotchi.spendCareOn('food', process.env.WORKING_PLAYER_TOKEN)
  ...
  console.log('   Trying to spend care point with invalid player token..'.grey)
  updatedGame = await kamerbotchi.spendCareOn('food', process.env.INVALID_PLAYER_TOKEN)
